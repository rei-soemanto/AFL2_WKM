...
@section('name', 'About')
@section('content')
<main class="main-page-wrapper about-bg">
    <div class="bg-overlay-standard py-5">
        <section id="about" class="container text-center">
            <h2 class="section-title mb-4 text-white">About <span class="text-gold">PT. Wraksa Kencana Mukti</span></h2>
            <p class="section-lead text-light mb-5 mx-auto fw-normal">
