        ...
        <div class="container-xl py-5">
            ...
            @if ($action === 'add' || $action === 'edit')
                ...
                <div class="card card-translucent shadow-lg p-4">
                    <div class="card-body">
                        <form action="{{ $action === 'edit' ? url('/admin/services/' . $service_to_edit['service_id']) : url('/admin/services') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if ($action === 'edit')
                                @method('PUT')
                            @endif
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <a href="{{ url('/admin/services') }}" class="text-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            @else
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ url('/admin/services/create') }}" class="btn btn-success btn-lg fw-bold">Add New Service</a>
                </div>
                            ...
                            <tbody>
                                @forelse ($services as $service)
                                    <tr>
                                        ...
                                        <td class="p-3 text-secondary">{{ $service['category_name'] ?? 'N/A' }}</td>
                                        <td class="p-3 text-secondary d-none d-md-table-cell">
                                            {{ \Carbon\Carbon::parse($service['updated_at'])->format('M j, Y, g:i a') }}
                                        </td>
