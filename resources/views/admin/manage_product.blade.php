        ...
        <div class="container-xl py-5">
                    ...
                    <div class="card-body">
                        <form action="{{ $action === 'edit' ? route('admin.products.update', $product_to_edit->id) : route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <a href="{{ route('admin.products.list') }}" class="text-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            @else
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('admin.products.create') }}" class="btn btn-primary btn-lg fw-bold">Add New Product</a>
                </div>
                                ...
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td class="p-3 text-secondary d-none d-md-table-cell">
                                            {{ $product->lastUpdatedBy->name ?? 'N/A' }} | {{ $product->updated_at->format('M j, Y, g:i a') }}
                                        </td>
                                        <td class="p-3 text-center text-nowrap">
                                            <a href="{{ route('admin.products.edit', $product->id) }}" class="btn btn-warning btn-sm fw-semibold text-dark">Edit</a>
